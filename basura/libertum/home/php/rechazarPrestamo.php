...
if ($mysqli){
  ...
  $query="UPDATE deudores set status=2 where idRegistro=$idRegistro";
  if($mysqli->query($query)){
		$resultado = array(
			'tipo'=>"success",
			'mensaje' => "El prestamo ha sido rechazado"
		); 
    ...
    $contenido=rechazoPrestamo($objetoOrigen,$objetoDestino,$objetoPrestamo);
    $asunto="Han rechazado tu prestado!!!";    
