...
<head>
  ...
  <style>
    ...
    .borde-1 {
      border: solid 10px #0681AB !important;
    }
    .fondo-1 {
      background-color:#0681AB !important;
    }
    .color-1 {
      color:#0681AB !important;
    }
            ...
            <tr>
              <td>
                <table class="row">
                  <tr>
                    <th>
                      <a href="https://www.libertum.co" target="_blank"><img src="https://www.libertum.co/home/img/bannerLibertum.jpg"></a>
                    </th>
                  </tr>
                </table>
                <table class="row">
                  <tr>
                    <th class="callout-inner">
                     <h2 class=" tituloPrincipal color-1">Hola %nombreDestino%.</h2>
                    </th>
                  </tr>
                </table>
                <table class="row">
                  <tr>
                    <th class="callout-inner">
                      <p>Te informamos que <b>%nombreOrigen%</b> te ha prestado dinero.</p>
                    </th>
                  </tr>
                </table>
                <table class="row">
                  <tr>
                    <th class="small-12 large-12 first columns">
                      <h3 class="color-1 text-center precio">%monto%</h3>
                    </th>
                  </tr>
                </table>
                <table class="row">
                  <tr>
                    <th class="callout-inner">
                      <p>Ingresa a Libertum para confirmar esta transacción y finalizar tu registro. Recuerda ingresar con tu correo electrónico y tu contraseña provisional:</p>
                 ...
                 <table class="row">
                  <tr>
                    <th class="small-12 large-12 first columns">
                      <h3 class="color-1 text-center precio">%password%</h3>
                    </th>
                  </tr>
                </table>
                ...
                <table class="row">
                  <tr>
                    <th class="small-12 large-12 first columns">
                      <a href="https://www.libertum.co"><div class="botonVer fondo-1">Ingresar</div></a>
                    </th>
                  </tr>
                </table>
                <table class="row xx">
                  <tr>
                    <th class="small-12 large-12 first columns text-center xx">
                      <a class="social" href="" target="_blank"><img style="margin:auto" src="https://www.sobreplanos.co/sobreplanos/img/icons/f.png" alt=""></a>
                      <a class="social" href="" target="_blank"><img style="margin:auto" src="https://www.sobreplanos.co/sobreplanos/img/icons/t.png" alt=""></a>
                      <a class="social" href="" target="_blank"><img style="margin:auto" src="https://www.sobreplanos.co/sobreplanos/img/icons/w.png" alt=""></a>
                    </th>
                     </tr>
                </table>
                <table class="row">
                  <tbody>
                    <tr>
                      <th>
                        <p class="text-center">Copyright © libertum.co 2020</p><br>
                      </th>
                    </tr>
                  </tbody>
                </table>                
