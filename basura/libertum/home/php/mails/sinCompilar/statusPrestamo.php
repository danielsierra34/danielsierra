            ...
            <tr>
              <td>
                ...
                <table class="row">
                  <tr>
                    <th class="callout-inner">
                     <h2 class=" tituloPrincipal color-1">Hola %nombreOrigen%.</h2>
                    </th>
                  </tr>
                </table>
                <table class="row">
                  <tr>
                    <th class="callout-inner">
                      <p>Te informamos que <b>%nombreDestino%</b> ha <b>%statusNuevo%</b> tu prestamo por:</p>
                    </th>
                  </tr>
                </table>
                <table class="row">
                ...
                <table class="row">
                  <tr>
                    <th class="callout-inner">
                      <p>Ingresa a Libertum para más información.</p>
