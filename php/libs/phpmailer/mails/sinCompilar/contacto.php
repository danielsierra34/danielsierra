...
<head>
  ...
  <style>
    ...
    .borde-1 {
      border: solid 10px #8275B5 !important;
    }
    .fondo-1 {
      background-color:#8275B5 !important;
    }
    .color-1 {
      color:#8275B5 !important;
    }
                ...
                <table class="row">
                  <tr>
                    <th class="callout-inner">
                     <h2 class=" tituloPrincipal color-1">Hola Admin</h2>
                    </th>
                  </tr>
                </table>
                <table class="row">
                  <tr>
                    <th class="callout-inner">
                      <table class="tabla tablaIconos">
                        <tr>
                          <td>Tienes un nuevo mensaje originado en el formulario de contacto:</td>                          
                        </tr>
                      </table>
                    </th>
                  </tr>
                  <tr>
                    <th class="callout-inner">
                      <table class="tabla tablaCompleta">
                        <tr>
                          <td>
                          <ul>
                ...
                <table class="row">
                  <tr>
                    <th class="small-12 large-12 first columns">
                      <a href="https://www.placelings.%origen%/respuestaContacto.php?id=%idRegistro%"><div class="botonVer fondo-1">Generar Respuesta</div></a>
                    </th>
                  </tr>
                </table>
                <table class="row xx">
