                      ...
                      <tbody>
                        <tr>
                          <th class="small-6 large-6 columns first">
                            <table>
                              <tr>
                                <th><img src="https://innovacion.puntored.co/img/puntored_500.png"></th>
                              </tr>
                            </table>
                          </th>
                        ...
                        <tr>
                          <th class="small-12 large-12 columns first last">
                            <table>
                              <tr>
                                <th>
                                  <h4>Notificación de Incidencias.</h4>
                                  <p>El siguiente Distribuidor ha notificado una incidencia propia a través del App Distribuidor.</p>
                                </th>
                              </tr>
                            </table>
                          </th>                        
                      ...
                      <tbody>
                        <tr>
                           <th class="small-12 large-4 columns first">
                            <table>
                              <tr>
                                <th><div class="fotoDistribuidor"><img src="https://innovacion.puntored.co/distribuidores/%fotoDistribuidor%" alt=""></div></th>
                              </tr>
                            </table>
                          </th>
                          <th class="small-12 large-8 columns last">
                            <table>
                              <tr>
                                <th>
                                 <ul class="no-bullet">
                                  <li><b>Nombres:</b>  %nombresDistribuidor%</li>
                                   <li><b>Apellidos:</b> %apellidosDistribuidor%</li>
                                   <li><b>Cédula:</b> %cedulaDistribuidor%</li>
                                   <li><b>Celular:</b> %celularDistribuidor%</li>
                                   <li><b>Email:</b> %emailDistribuidor%</li>
                                  </ul>
                                </th>
                              </tr>
                            </table>
                      ...
                      <tbody>
                        <tr>
                           <th class="small-12 large-4 columns first">
                            <table>
                              <tr>
                                <th>
                                 <ul class="no-bullet">
                                  <li><b>Categoria:</b>  %categoriaIncidencia%</li>
                                   <li><b>Prioridad:</b> %prioridadIncidencia%</li>
                                   <li><b>Fecha:</b> %fechaIncidencia%</li>
                                   <li><b>Hora:</b> %horaIncidencia%</li>
                                  </ul>
                                </th>
                              </tr>
                            </table>
                           ...
                           <th class="small-12 large-8 columns last">
                            <table>
                              <tr>
                                <th><div class="fotoIncidencia"><img src="https://innovacion.puntored.co/incidencias/%fotoIncidencia%" alt=""></div></th>
                              </tr>
                            </table>
                          </th>                        
